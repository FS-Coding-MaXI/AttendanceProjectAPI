...
from services.student_service import add_student_to_class_service, get_students_by_search_term, remove_student_from_class_service
...
async def add_student_to_class(student_id: int, class_id: int, db: Session = Depends(get_db), current_user: UserPublic = Depends(get_current_user)):
...
async def remove_student_from_class(student_id: int, class_id: int, db: Session = Depends(get_db), current_user: UserPublic = Depends(get_current_user)):
