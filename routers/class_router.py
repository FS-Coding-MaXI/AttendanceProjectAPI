...
from services.class_service import fetch_class_by_id, remove_class, validate_and_create_class, fetch_classes_for_user
...
async def get_class_by_id_endpoint(class_id: int, db: Session = Depends(get_db), current_user: UserPublic = Depends(get_current_user)):
